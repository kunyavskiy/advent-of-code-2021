...
private fun dfs(x:Int, y:Int, mark:Pair<Int, Int>, used:Array<Array<Pair<Int, Int>?>>, data:List<String>) : Int = when {
    x !in data.indices -> 0
...
private fun hard(data: List<String>) = Array(data.size) { Array<Pair<Int, Int>?>(data[0].length) { null }}.let { used ->
